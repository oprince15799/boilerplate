...
namespace Boilerplate.Infrastructure.Extensions.ViewRenderer.Razor.Features
{
    public static class ServiceCollectionExtensions
    {
        ...
        {
            return services.AddFeatureFolders(new FeatureFolderOptions());
        }
        ...
        {
            return services.AddAreaFeatureFolders(new AreaFeatureFolderOptions());
        }
    }
}